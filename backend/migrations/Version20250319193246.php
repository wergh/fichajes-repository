 ...
 */
final class Version20250319193246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_entry_logs ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE work_entry_logs DROP created_at');
    }
}
